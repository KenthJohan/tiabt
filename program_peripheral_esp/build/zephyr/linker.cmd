...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0x0), LENGTH = (808*1K - 0x0)
...
. = ALIGN( 1 << ((((4 * (16 + 63)) <= 4) ? 2 : (((4 * (16 + 63)) <= 8) ? 3 : (((4 * (16 + 63)) <= 16) ? 4 : (((4 * (16 + 63)) <= 32) ? 5 : (((4 * (16 + 63)) <= 64) ? 6 : (((4 * (16 + 63)) <= 128) ? 7 : (((4 * (16 + 63)) <= 256) ? 8 : (((4 * (16 + 63)) <= 512) ? 9 : (((4 * (16 + 63)) <= 1024) ? 10 : (((4 * (16 + 63)) <= 2048) ? 11 : (((4 * (16 + 63)) <= 4096) ? 12 : (((4 * (16 + 63)) <= 8192) ? 13 : (((4 * (16 + 63)) <= 16384) ? 14 : (((4 * (16 + 63)) <= 32768) ? 15:(((4 * (16 + 63)) <= 65536) ? 16 : (((4 * (16 + 63)) <= 131072) ? 17 : (((4 * (16 + 63)) <= 262144) ? 18:(((4 * (16 + 63)) <= 524288) ? 19 : (((4 * (16 + 63)) <= 1048576) ? 20 : (((4 * (16 + 63)) <= 2097152) ? 21 : (((4 * (16 + 63)) <= 4194304) ? 22 : (((4 * (16 + 63)) <= 8388608) ? 23 : (((4 * (16 + 63)) <= 16777216) ? 24 : (((4 * (16 + 63)) <= 33554432) ? 25 : (((4 * (16 + 63)) <= 67108864) ? 26 : (((4 * (16 + 63)) <= 134217728) ? 27 : (((4 * (16 + 63)) <= 268435456) ? 28 : (((4 * (16 + 63)) <= 536870912) ? 29 : (((4 * (16 + 63)) <= 1073741824) ? 30 : (((4 * (16 + 63)) <= 2147483648) ? 31 : 32))))))))))))))))))))))))))))))) );
_vector_start = .;
...
/DISCARD/ :
{
 ...
 KEEP(*(.gnu.attributes))
    ...
    SRAM1 537067520 (NOLOAD) : { __SRAM1_start = .; KEEP(*(SRAM1)) KEEP(*(SRAM1.*)) __SRAM1_end = .; } > SRAM1 __SRAM1_size = __SRAM1_end - __SRAM1_start; __SRAM1_load_start = LOADADDR(SRAM1); SRAM2 537100288 (NOLOAD) : { __SRAM2_start = .; KEEP(*(SRAM2)) KEEP(*(SRAM2.*)) __SRAM2_end = .; } > SRAM2 __SRAM2_size = __SRAM2_end - __SRAM2_start; __SRAM2_load_start = LOADADDR(SRAM2);
.last_section (NOLOAD) :
{
} > FLASH
